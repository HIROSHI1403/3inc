...
<body>
	...
	<main>
		...
		<section class="margin-bottom-50">
			<div class="jumbotron jumbotron-vps">
				<div class="container whiter sd text-center">
					<h2 class="wow fadeInUp">大型商業施設向け<br>顧客管理＆分析サービス</h2>
					<p class="wow fadeInUp c-3inc-green h2">VPSサービス</p>
				</div>
			</div>
		</section>
		...
		<section>
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12">
						<!-- <h1 class="top-title c-3inc">VPSサービス</h1>
						<p class="c-3inc-sub lead">大型商業施設向け顧客管理＆分析サービス</p> -->
						<p class="text-center lead">ショッピングモールなどの大型商業施設やディベロッパーに最適な、顧客分析サービスです。大規模な会員管理を可能にし、分析による効果的な販促や、複数の施設やテナントを一元管理できるサービスです。</p>
					</div>
			...
			<div class="container">
				...
				<h3 class="c-3inc margin-top-200">サービス特長</h3>
			 	<div class="row">
					<div class="col-md-4">
						<h4 class="c-3inc-sub">施設内にあるいろいろな端末を会員管理に利用</h4>
						<p>
							施設内の「ポイント端末」や「クレジット端末」、「POS端末」、「KIOSK端末」のほか、映画館や劇場などに設置されている「発券機」など、いろいろな端末をポイント・会員管理として利用できます。
						</p>
					</div>
					<div class="col-md-4">
						<h4 class="c-3inc-sub">会員の動向分析や売上集計データ提供</h4>
						<p>
							施設別、日別、地区や性別・年齢などの会員属性別などさまざまなパターンの情報を抽出することがでるため、キャンペーンやイベントなどの施策に役立てられます。また、日次・月次売上データの自動生成により報告書作成の手間が省けます。
						</p>
					</div>
					<div class="col-md-4">
						<h4 class="c-3inc-sub">特定の会員に向けた効果的な販促支援</h4>
						<p>
							購買履歴や会員属性など条件を設定してデータを抽出し、ターゲットに合わせたダイレクトメールやクーポン配信など最適な販促活動をサポートします。また、「ゴールド会員」「シルバー会員」などのランク別サービスも提供できます。
						</p>
					</div>
			 	</div>
