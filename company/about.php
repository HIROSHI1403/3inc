					...
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-hover table-bordered">
								<tbody>
									<tr>
										<th class="c-3inc-sub">企業名</th>
										<td>株式会社トリニティ　Trinity Inc.</td>
									</tr>

									<tr>
										<th class="c-3inc-sub">本社所在地</th>
										<td>
									...
									<tr>
										<th class="c-3inc-sub">資本金</th>
										<td>380百万円</td>
									</tr>

									<tr>
										<th class="c-3inc-sub">設立</th>
										<td>1986年3月</td>
									</tr>

									<tr>
										<th class="c-3inc-sub">代表者</th>
										<td>代表取締役社長 平田 隆三郎</td>
									</tr>

									<tr>
										<th class="c-3inc-sub">従業員数</th>
										<td>61名（男性45名/女性16名）</td>
									</tr>

									<tr>
										<th class="c-3inc-sub">主要取引銀行</th>
										<td>肥後銀行</td>
									</tr>
