			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
						<div class="page-header">
							<h2 class="c-3inc-sub">エントリーフォーム</h2>
						</div>
					</div>
				</div>
				...
				<form class="form-horizontal" action="check.php" method="POST">
					<fieldset>
						...
						<div class="form-group">
							<label for="campus" class="col-lg-2 control-label">学校名&nbsp;<span class="label label-danger">必須</span></label>
							<div class="col-lg-10">
								<input type="text" class="form-control" id="campus" name="campus" placeholder="例）〇〇大学" required>
								<span class="help-block">最終学歴</span>
							</div>
						</div>

						<div class="form-group">
							<label for="department" class="col-lg-2 control-label">学部学科名&nbsp;<span class="label label-danger">必須</span></label>
							<div class="col-lg-10">
								<input type="text" class="form-control" id="department" name="department" placeholder="例）〇〇学部〇〇学科" required>
								<span class="help-block">最終学歴</span>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<div class="radio">
									<label>
										<input type="radio" name="option" id="optionsRadios1" value="新卒" required checked>
										新卒の方
									</label>
								</div>
								<div class="radio">
						...
						<div class="form-group">
							<div class="col-lg-10 col-lg-offset-2">
								...
								<button type="submit" name="submit" value="entry" class="btn btn-iij">内容確認</button>
							</div>
						</div>
						<p>
							<hr>
