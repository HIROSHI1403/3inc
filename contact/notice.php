		...
		<section class="margin-bottom-50">
              <div class="jumbotron jumbotron-contact">
                    <div class="container whiter sd text-center">
                          <h2 class="wow fadeInUp">CONTACT/ENTRY</h2>
                          <p class="wow fadeInUp">お問い合わせ／応募</p>
                    </div>
              </div>
        </section>
				...
				<div class="well well-sm">
			 	...
			 	<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 hvr-float">
                        <div class="panel panel-default phover text-center wow fadeInUp">
							<div class="panel-body">
							    <h4 class="c-iij">採用に関するお問い合わせ</h4>
							</div>
							<div class="panel-footer">
								<p><a href="<?php echo SRV_ROOT; ?>/contact/entry.php" class="btn btn-iij">お問合せ</a><a href="<?php echo SRV_ROOT; ?>" class="btn btn-link">同意しない</a></p>
								<p><small>※お問い合わせに関する注意事項にご同意いただけた方のみお問合せください。</small></p>
							</div>
                        </div>
					</div>
